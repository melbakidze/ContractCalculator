...
namespace Invoices
{
    public class CostSummaryFactory
    {
        ...
        public static void CreateWeekly(Document document, WeeklyInvoiceDetails wid, InvoiceEntity invoiceEntity)
        {
            ...
            AddHeader(table);
            AddWeekWorkCost(table, wid, invoiceEntity);
        ...
        private static void AddWeekWorkCost(PdfPTable table, WeeklyInvoiceDetails wid, InvoiceEntity invoiceEntity)
        {
