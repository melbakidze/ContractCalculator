...
namespace Invoices
{
    ...
    {
        public static void Create(IElementListener document, int invoiceNumber, InvoiceEntity invoiceEntity, CompanyInformationEntity companyInformationEntity)
        {
            ...
            table.AddCell(GetInvoiceDetails(invoiceNumber));
            document.Add(table);
        }
        ...
        public static PdfPCell GetInvoiceDetails(int invoiceNumber)
        {
